...
vi.mock("../lib/obsidian/config", () => ({
  isVaultConfigured: vi.fn(),
}));
vi.mock("../lib/obsidian/write", () => ({
  writeVaultNote: vi.fn(),
}));

import { isSupabaseConfigured, writeAuditEvent } from "../lib/supabase/admin";
...
import type { DbNoteRow } from "../lib/supabase/notes";
