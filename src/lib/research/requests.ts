 ...
 * nothing here auto-runs research or auto-files a finding. There is no filing
 * module yet — today, filing a finding into knowledge/sources/ is a manual,
 * hand-authored step. A future lib/research/fileFinding.ts would close that
 * loop, but it does not exist in this repo yet.
 */
