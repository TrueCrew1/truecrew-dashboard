...
import { EmptyState, PageHeader, Panel, StatusBadge, TableScroll } from "@/components/ui";
        ...
        <div className="grid-2">
          ...
          <Panel title="Integrations">
            {healthLoading ? (
              ...
              <div className="panel-empty" data-empty="settings-health" role="status">
                <EmptyState
          ...
          >
            <table className="data-table">
              ...
              <tbody>
                ...
                <tr>
                  <td>Runtime host</td>
                  <td className="cell-mono cell-truncate" title={health?.host ?? undefined}>
                    {healthLoading && liveApi
                      ? "Checking…"
                      : health?.host ?? (liveApi ? "unknown" : "mock — no host")}
                  </td>
                </tr>
                <tr>
                  <td>Data source</td>
