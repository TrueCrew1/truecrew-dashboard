...
import type { DbNoteRow, UpsertNoteInput } from "../supabase/notes.js";
...
vi.mock("../supabase/notes.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../supabase/notes.js")>();
  return {
    ...actual,
...
vi.mock("../obsidian/write.js", () => ({
  writeVaultNote: writeVaultNoteMock,
}));

import { createTaskArtifact, listTaskArtifacts } from "./create.js";
